...
export const RPC_MANIFEST: RpcManifestEntry[] = [
  ...
  {
    name: "save_msme_stage",
    classification: "public_rpc",
    expectedAnonExecute: false,
    expectedAuthenticatedExecute: true,
    requiredAppRole: "staff",
    introducedIn: "0026_msme_drafts.sql",
    notes: "Upserts the case's MSME draft (merged form data, stage, optimistic version); refused once filed/locked; audits msme.stage_saved.",
  },
  {
    name: "lock_msme_draft",
    classification: "public_rpc",
    expectedAnonExecute: false,
    expectedAuthenticatedExecute: true,
    requiredAppRole: "staff",
    introducedIn: "0026_msme_drafts.sql",
    notes: "Permanently locks the draft when the ODR filing is submitted (diary number); idempotent for the same diary; audits msme.draft_locked.",
  },
  {
    name: "msme_drafts_block_locked_change",
    classification: "internal_helper",
    expectedAnonExecute: false,
    expectedAuthenticatedExecute: false,
    requiredAppRole: "internal_only",
    introducedIn: "0026_msme_drafts.sql",
    notes: "Trigger function: a locked msme_drafts row can never be updated or deleted.",
  },
  {
