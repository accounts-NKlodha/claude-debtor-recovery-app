/**
 * TanStack Start adapter for src/components/screens/case-detail.tsx --
 * identical JSX/Tailwind/business logic verbatim. This orchestrator itself
 * has no Next.js dependency beyond LinkButton (swapped for the TanStack
 * adapter); every embedded panel below is its own thin adapter copy in
 * this same directory (only their next/navigation or Server Action
 * dependency swapped, markup/logic untouched).
 */
"use client";
